...
eststo: quietly regress log_unrelated_party_revenues stat_rate log_ngdpd log_fma log_dist, robust
estadd local fe No
estadd local exclude_US No

eststo: quietly regress log_unrelated_party_revenues stat_rate log_ngdpd log_fma log_dist is_domestic contig comlang_off comlang_ethno col45 is_eu rta, robust
estadd local fe No
...
eststo: quietly regress log_unrelated_party_revenues eatr log_ngdpd log_fma log_dist is_domestic contig comlang_off comlang_ethno col45 is_eu rta i.year, robust
estadd local gravity_controls Yes
estadd local fe Yes

eststo: quietly regress log_unrelated_party_revenues emtr log_ngdpd log_fma log_dist is_domestic contig comlang_off comlang_ethno col45 is_eu rta i.year, robust
estadd local gravity_controls Yes
estadd local fe Yes
...
eststo: quietly regress log_unrelated_party_revenues stat_rate stat_rate_squared log_ngdpd log_fma log_dist is_domestic contig comlang_off comlang_ethno col45 is_eu rta i.year, robust
estadd local gravity_controls Yes
estadd local fe Yes

eststo: quietly regress log_unrelated_party_revenues eatr eatr_squared log_ngdpd log_fma log_dist is_domestic contig comlang_off comlang_ethno col45 is_eu rta i.year if code != "USA", robust
estadd local gravity_controls Yes
estadd local fe Yes
